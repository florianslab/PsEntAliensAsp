...
// 
// Version 1.1 - 08.17.2016
//
// Changes:
//   - Removed the 'picFilename' parameter
//     (now use the 'background' CSS property in the general parameters)
//   - Added the 'background-size: cover' option by default to each element
//
...
var c2u = (function() {
   ...
   return {
     ...
     newPicture: function (patches, parameters) {
         ...
         picture.css({position: "relative", "background-size": "cover"});
         ...
         if (patches != null && Array.isArray(patches)) {
           for (patch in patches) {
               ...
               // Adjusting the size by default
               divPatch.css("background-size", "cover")
