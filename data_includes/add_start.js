startItems = [
  ...
  ["practice1", "DynamicQuestion", {
        ...
        randomOrder: null,
        answers: {
                  Target: ["F", newAliens([ ["alien_yellow.png", "alien_yellow.png", "alien_red.png"],
                                      ["alien_blue.png", "alien_blue.png", "alien_blue.png"],
                                      ["alien_yellow.png", "alien_yellow.png", "alien_blue.png"],
                                      ["alien_blue.png", "alien_blue.png", "alien_blue.png"]
                                    ], ["Planet FV", "Planet ZY"])],
                  Covered: ["J", newAliens([
        ...
        sequence: [
          ...
          TT("#Target", "If you think the visible picture matches the description ('Exactly one alien started to be red on Planet ZY'), you press the corresponding key (here, <b>F</b>).", "Press Space", "tc"),
          {pause: "key\x01"},
          ...
          function(t){
            setTimeout(function() {
              ...
              if ("F".match(t.pressedKey))
                TT("#Target", "Right: in this picture, exactly one alien started to be red on Planet ZY.", "Press Space to Proceed", "tc")(t);
              else if ("J".match(t.pressedKey))
                TT("#Covered", "<span style='color: red;'>Wrong: you should go with the visible picture, "+
                               "where exaclty one alien started to be red on Planet ZY</span>", "Press Space to Proceed", "tc")(t);
            }, 12);
          },
          {pause: "key\x01"}
        ]
  ...
  ["practice2", "DynamicQuestion", {
        ...
        randomOrder: null,
        answers: {
                  Target: ["F", newAliens([ ["alien_orange.png", "alien_orange.png", "alien_pink.png"],
                                      ["alien_green.png", "alien_green.png", "alien_green.png"],
                                      ["alien_orange.png", "alien_orange.png", "alien_pink.png"],
          ...
          function(t){
            setTimeout(function() {
              ...
              if ("J".match(t.pressedKey))
                TT("#Covered", "Right: in the visible picture, there wasn't exactly one alien that started to be pink on Planet XF, so the covered picture is a better guess.", "Press Space to Proceed", "tc")(t);
              else if ("F".match(t.pressedKey))
                TT("#Target", "<span style='color: red;'>Wrong, you should go with the covered picture, "+
                               "which is a better guess: there wasn't exactly one alien that started to be pink on Planet XF in the visible picture.</span>", "Press Space to Proceed", "tc")(t);
            }, 12);
          },
          {pause: "key\x01"}
        ]
