stillItems = [
  ...
  ["practice1", "DynamicQuestion", {
        ...
        sequence: [
          ...
          TT("#Target", "If you think the visible picture matches the description ('Exactly one alien still was red on Planet ZY'), you press the corresponding key (here, <b>F</b>).", "Press Space", "tc"),
          {pause: "key\x01"},
          ...
          function(t){
            setTimeout(function() {
              ...
              if ("F".match(t.pressedKey))
                TT("#Target", "Right: in this picture, exactly one alien still was red on Planet ZY.", "Press Space to Proceed", "tc")(t);
              else if ("J".match(t.pressedKey))
                TT("#Covered", "<span style='color: red;'>Wrong: you should go with the visible picture, "+
                               "where exaclty one alien still was red on Planet ZY</span>", "Press Space to Proceed", "tc")(t);
            }, 12);
          },
          {pause: "key\x01"}
        ]
          ...
          function(t){
            setTimeout(function() {
              ...
              if ("J".match(t.pressedKey))
                TT("#Covered", "Right: in the visible picture, there wasn't exactly one alien that still was pink on Planet XF, so the covered picture is a better guess.", "Press Space to Proceed", "tc")(t);
              else if ("F".match(t.pressedKey))
                TT("#Target", "<span style='color: red;'>Wrong, you should go with the covered picture, "+
                               "which is a better guess: there wasn't exactly one alien that still was pink on Planet XF in the visible picture.</span>", "Press Space to Proceed", "tc")(t);
            }, 12);
          },
          {pause: "key\x01"}
        ]
