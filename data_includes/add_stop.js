stopItems = [
  ...
  ["practice1", "DynamicQuestion", {
        ...
        sequence: [
          ...
          {pause: "key\x01"},
          TT("#Covered", "Each picture shows a different group of four aliens, but black squares cover the aliens on this picture.", "Press Space", "tr"),
          {pause: "key\x01"},
          ...
          {pause: "key\x01"},
          TT("#Target #alienAlienRight2", "In this case, these four aliens had a transit on Planet FV, before settling on Planet ZY.", "Press Space", "tc"),
          {pause: "key\x01"},
          TT("#Target #alienAlienRight2", "All the aliens were born on their Home Planet in a particular color.", "Press Space", "tc"),
          {pause: "key\x01"},
          ...
          TT("#sentence", "A sentence at the top of the screen will describe an initial situation.", "Press Space", "bc"),
          {pause: "key\x01"},
          ...
          {pause: "key\x01"},
          TT("#Covered", "... or whether it is more likely that it describes what happened to these aliens, behind the black squares.", "Press Space", "bc"),
          {pause: "key\x01"},
