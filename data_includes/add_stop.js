stopItems = [
  ...
  ["practice1", "DynamicQuestion", {
        ...
        sequence: [
          TT("#bod", "This experiment is a guessing game: in every trial, you will see two pictures "+
                             "and you will have to select the one that corresponds what you hear.", "Press Space", "mc"),
          {pause: "key\x01"},  
          ...
          function(t){ $("#sentence, #Covered, [id^=alienArrowMiddle], [id^=alienAlienRight], .DynamicQuestion-keyLabel").css("visibility", "hidden"); },
          ...
          {pause: "key\x01"},     
          TT("#Target #alienAlienLeft0", "The aliens in this experiment travel in groups of four from their Home Planet to their final destination...", "Press Space", "tr"),
          {pause: "key\x01"},
          TT("#Target #alienAlienMiddle0", "... via a planet of transit.", "Press Space", "tr"),
          {pause: "key\x01"},
          TT("#Target", "In this case, these four aliens had a transit on Planet FV, before settling on Planet ZY.", "Press Space", "tr"),
          {pause: "key\x01"},
          TT("#Target #alienAlienLeft0", "All the aliens were born on their Home Planet in a particular color.", "Press Space", "tr"),
          {pause: "key\x01"},
          TT("#Target #alienAlienMiddle0", "As you can see, nothing happened to their color while they were in transit on Planet FV.", "Press Space", "mr"),
          {pause: "key\x01"},
          ...
          TT("#Target", "Your task will be to judge whether this picture is accurately described by the sentence you just heard...", "Press Space", "bc"),
          {pause: "key\x01"},
          TT("#Covered", "... or whether it is a better guess that what is depicted behind those black squares matches what you just heard.", "Press Space", "bc"),
          {pause: "key\x01"},
          ...
          function(t){
            setTimeout(function() {
              ...
              if ("F".match(t.pressedKey))
                TT("#alienAlienRight0", "Right: in this picture, only this alien stopped being red on Planet ZY.", "Press Space to Proceed", "tc")(t);
  ...
  ["practice2", "DynamicQuestion", {
        ...
        sequence: [
          ...
          {pause: "key\x01"},
          TT("#Target #alienAlienRight0", "These four aliens are taveling to Planet XF.", "Press Space", "tr"),
          {pause: "key\x01"},
          TT("#Target #alienAlienMiddle0", "They are transiting via Planet TH.", "Press Space", "tr"),
          {pause: "key\x01"},
          TT("#sentence", "As highlighted in this sentence, their color remained unchanged during their transit on Planet TH.", "Press Space", "bc"),
          {pause: "key\x01"},
          ...
          {audio: "practice2.mp3", waitFor: true},
          function(t){ $("#press").css("display", "block"); },
          function(t){ $(".DynamicQuestion-keyLabel").css("visibility", "visible"); },
          TT("#Target", "If you think the visible picture matches the description, press <b>J</b>.", "Press Space", "tc"),
          {pause: "key\x01"},
  ...
  GetItemsFrom(dataStop, null, {
    ...
    Elements:[
      ...
      "DynamicQuestion",
      {
        legend: function(row){return[row.item,row.Expt,row.Condition,row.HerAlsoStop,row.Critical,
